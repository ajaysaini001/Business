...
const Hero = () => {
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`${styles.flexStart} flex-col  x:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px]
         ...
         <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            Our team of experts uses a methdlogy to identify the credits cards most likely to fit your
            needs.We example annual percentage rats, annual fees.
         </p>
         </div>
